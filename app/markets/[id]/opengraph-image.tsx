        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center',
              width: 44, height: 44, borderRadius: 11, background: '#0052ff', marginRight: 14 }}>
              <div style={{ display: 'flex', fontSize: 28, fontWeight: 800, color: '#ffffff' }}>P</div>
            </div>
            <div style={{ display: 'flex', fontSize: 34, fontWeight: 800, color: '#f5f6f8' }}>Predacle</div>
          </div>
