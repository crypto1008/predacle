...
export async function generateMetadata(
  ...
  return {
    ...
    alternates: { canonical: url },
    openGraph: { title: cat.title, description: cat.description, url, siteName: 'Predacle', locale: 'en_US', type: 'website', images: [{ url: '/opengraph-image', width: 1200, height: 630, alt: 'Predacle — Every prediction market, one place' }] },
